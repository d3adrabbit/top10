    ...
    <div>
      <main className="">
        <div className="relative">
          <div className="absolute top-0 left-0 w-full h-screen ">
            <div className="grid items-center justify-center h-full grid-cols-8 grid-rows-4 px-10">
              {posters.map((item, index) => {
                return (
                  ...
                  >
                    <Image
                      className="cursor-pointer rounded-2xl grayscale"
                      src={item.image}
                      width={223 / 2}
                      height={353 / 2}
                      alt=""
          ...
          <div className="fixed z-20 -translate-x-1/2 left-1/2 bottom-10">
            <motion.div
              className="flex items-center text-[#f7c98c]"
              style={{
                opacity,
              }}
            >
              <ArrowDownCircleIcon className="w-6 h-6 "></ArrowDownCircleIcon>
              <div className="ml-2" style={libre.style}>
                Scroll Down
              </div>
            </motion.div>
          </div>

          <div className="relative w-full text-[#f7c98c]">
            <div className="flex flex-col items-center justify-center h-screen font-black text-8xl">
              <div style={libre.style} className="leading-normal">
                <div>Top 10 </div>
                <div className="ml-56">Greatest Movies</div>
                <div className="ml-32">Of All Time.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div>
            <motion.div className="flex flex-col items-center justify-center h-screen text-4xl font-bold leading-tight">
              <div className="" style={{}}>
                <Award></Award>
              </div>
              <div className="mt-8 text-center">
                <div>这个列表基于我个人的喜好</div>
                <div>排名根据他们奖项、提名和受欢迎程度</div>
                <Link
                  className="inline-block px-5 py-3 mt-10 text-xs font-light border rounded-full"
                  href={"/"}
                >
                  <div className="flex items-center">
                    <span> 查看前 100 名列表</span>
                    <ArrowUpRightIcon className="w-2 h-2 ml-2 text-black"></ArrowUpRightIcon>
                  </div>
                </Link>
              </div>
            </motion.div>
          ...
          <div className="">
            {list.map((item, index) => {
              return (
                <div
                  key={index}
                  className="grid grid-cols-8 border-t border-[#e6e6e6]"
                >
                  <div
                    className="border-l border-[#e6e6e6] p-5 "
                    style={{
                      gridColumnStart: 2,
                      gridColumnEnd: 5,
                    }}
                  >
                    <div className="h-full">
                      ...
                      <Link
                        href={"/"}
                        className="inline-block px-5 py-3 mt-10 border rounded-full border-black/40"
                      >
                        <div className="flex items-center">
                          <div>Learn More</div>
                          <ArrowUpRightIcon className="w-3 h-3 ml-2 text-black"></ArrowUpRightIcon>
                        </div>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div
                    className="border-l border-[#e6e6e6] p-5  aspect-square border-r"
                    style={{
                      gridColumnStart: 5,
                      gridColumnEnd: 8,
                    }}
                  >
                    ...
                    <div className="mt-10">
                      <div className="font-light">Screenplay.</div>
                      <div className="mt-5 text-3xl font-black ">
                        {item.screenplay}
                      </div>
                    </div>
                    ...
                    <div className="mt-10">
                      <div className="text-justify ">
                        <div className="font-light">Introduction.</div>
        ...
        <div
          className="grid items-center grid-cols-8 my-20"
          style={{
            fontFamily: "'Noto Serif SC', serif",
          }}
        >
          <div className="flex justify-center">
            <div className="p-4 transition-all border rounded-full cursor-pointer border-black/40 group hover:bg-black">
              <ChevronLeftIcon className="w-6 h-6 text-black/40 group-hover:text-white"></ChevronLeftIcon>
            </div>
          </div>
          <div
            style={{
          ...
          >
            <div
              className="relative w-full overflow-hidden transition-all duration-700 bg-no-repeat bg-cover aspect-video rounded-3xl"
              style={{
                backgroundImage:
                  "url(https://www.themoviedb.org/t/p/original/tvzlqpf7FgtBBBosJZIoRKtx6UZ.jpg) ",
              }}
            >
              <div className="absolute bottom-0 w-full p-5 bg-white/20 backdrop-blur-xl rounded-2xl">
                ...
                <div className="mt-5 mb-5 text-sm text-white/70">
                  阿拉贡、精灵莱戈拉斯、矮人金利一路追踪兽人，营救皮平和梅利，遇到了“复活”的白袍巫师甘道夫。此时，投降索伦的白袍巫师萨鲁曼控制了洛汉国国王，并派出大量的兽人军队准备消灭人类...
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="p-4 transition-all border rounded-full cursor-pointer border-black/40 group hover:bg-black">
              <ChevronRightIcon className="w-6 h-6 text-black/40 group-hover:text-white"></ChevronRightIcon>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="relative h-screen ">
        <div className="grid h-screen grid-cols-8">
          <div
            className="border-l  border-[#e6e6e6]"
            style={{
              gridColumnStart: 2,
              gridColumnEnd: 5,
            }}
          ></div>
          <div
            className="border-l border-r border-[#e6e6e6] h-screen"
            style={{
              gridColumnStart: 5,
              gridColumnEnd: 8,
            }}
        ...
        <div
          className={clsx(
            "absolute top-0 w-full flex flex-col items-center justify-center h-screen"
          )}
          style={libre.style}
        >
          <div className="text-6xl font-bold text-center uppercase ">
            <div className="text-5xl">VOL. 30</div>
            <div className="mt-20">THANK YOU FOR WATCHING</div>
            <div className="mt-5 text-2xl"> Created by @DeadRabbit</div>
          </div>

          <div className="absolute w-full px-10 font-semibold uppercase bottom-10">
            <div className="flex justify-between">
              <div>Web Designer</div>
              <div>deadrabbit.online</div>
              <div>©2023</div>
              <div>Works</div>
...
const Award = () => {
  return (
    ...
    >
      ...
      <g
        transform="translate(0.000000,972.000000) scale(0.100000,-0.100000)"
        fill="#f7c98c"
        stroke="none"
      >
        <path
          d="M3120 9617 c-595 -270 -881 -532 -991 -908 -17 -60 -22 -109 -26
    ...
    172 -11 356 -80 560 -41 124 -131 328 -201 458 l-55 104 -51 -94z"
        />
        <path
          d="M11127 9259 c-134 -251 -231 -511 -268 -715 -30 -168 -23 -431 15
    ...
    641 -284 1054 l-63 118 -56 -103z"
        />
        <path
          d="M2845 8326 c-214 -72 -300 -107 -423 -171 -344 -182 -554 -413 -632
    ...
    -5 0 -80 -24 -168 -54z"
        />
        <path
          d="M9790 8375 c0 -6 34 -126 67 -239 4 -13 2 -16 -7 -11 -10 6 -12 -4
    ...
    -40 12 -80 24 -87 27 -8 3 -14 2 -14 -2z"
        />
        <path
          d="M897 7985 c-61 -204 -79 -269 -101 -370 -45 -210 -59 -352 -51 -520
    ...
    -22 237 -60 223 -182 446 -395 718 -142 181 -133 172 -140 150z"
        />
        <path
          d="M11840 7928 c-144 -186 -177 -230 -238 -323 -187 -286 -268 -533
    ...
    59 547 -1 176 -5 224 -27 339 -26 134 -117 471 -127 470 -3 0 -30 -32 -60 -71z"
        />
        <path
          d="M376 6383 c5 -76 9 -168 9 -205 0 -36 2 -63 5 -58 3 4 6 -22 7 -58 2
    ...
    -314 192 -4 0 -2 -62 2 -137z"
        />
        <path
          d="M12316 6455 c-526 -317 -781 -605 -842 -955 -16 -95 -15 -319 2 -365
    ...
    110 13 187 7 77 14 166 17 198 3 31 1 57 -3 57 -4 0 -56 -29 -116 -65z"
        />
        <path
          d="M2159 5863 c-398 -419 -576 -784 -554 -1138 3 -60 8 -146 10 -190 7
    ...
    410 -4 0 -53 -48 -110 -107z"
        />
        <path
          d="M10522 5925 c-64 -279 -84 -463 -80 -722 2 -116 5 -210 8 -208 3 2 6
    ...
    l-128 132 -11 -49z"
        />
        <path
          d="M200 5103 c0 -2 18 -40 41 -84 47 -95 62 -132 50 -125 -15 10 -18
    ...
    26 -182 29 -13 2 -23 2 -23 -1z"
        />
        <path
          d="M12550 5099 c-232 -36 -334 -55 -445 -84 -484 -122 -761 -346 -880
    ...
    6 6 6 11 1 17 -2 13 -5z"
        />
        <path
          d="M10242 4632 c-46 -140 -92 -319 -118 -457 -18 -94 -28 -519 -12 -509
    ...
    795 -39 51 -74 95 -77 99 -4 4 -26 -50 -49 -120z"
        />
        <path
          d="M2407 4612 c-305 -408 -443 -757 -422 -1067 3 -55 8 -140 10 -190 5
    ...
    137 -117 405 -126 405 -5 0 -55 -62 -111 -138z"
        />
        <path
          d="M2970 3839 c-189 -385 -254 -632 -248 -941 2 -86 6 -151 10 -145 5 7
    ...
    -87 165 -98 184 l-21 35 -81 -165z"
        />
        <path
          d="M9711 3929 c-124 -219 -230 -466 -276 -642 -39 -151 -47 -234 -41
    ...
    453 2 36 8 111 13 167 26 288 -56 600 -266 1017 l-60 120 -42 -75z"
        />
        <path
          d="M3645 3278 c-2 -7 -14 -78 -27 -158 -19 -123 -22 -188 -23 -430 -2
    ...
    645 -147 152 -244 237 -250 219z"
        />
        <path
          d="M8994 3143 c-289 -284 -435 -492 -514 -732 -32 -100 -55 -261 -45
    ...
    -147z"
        />
        <path
          d="M4501 2358 c52 -129 69 -179 59 -173 -6 4 -10 -12 -10 -42 0 -78 115
    ...
    5 -24 16 -52z"
        />
        <path
          d="M8159 2375 c-609 -138 -940 -344 -1096 -683 -59 -127 -110 -377 -88
    ...
    -5 0 -74 -16 -154 -34z"
        />
        <path
          d="M4032 1479 c-193 -25 -435 -124 -667 -274 -108 -69 -314 -218 -315
    ...
    29 77 21 29 39 55 39 58 0 3 -25 24 -55 46 -229 167 -469 236 -713 204z"
        />
        <path
          d="M8513 1476 c-155 -30 -317 -101 -446 -196 l-67 -50 40 -54 c37 -49
    ...
    -550 347 -780 395 -113 23 -257 28 -343 12z"
        />
        <path
          d="M6324 1249 c-48 -14 -120 -83 -139 -134 -13 -34 -16 -60 -11 -112 4
    -37 6 -84 6 -103 -2 -95 62 -193 145 -220 138 -46 285 52 292 195 1 28 8 71
    14 97 10 37 10 60 0 101 -31 139 -167 217 -307 176z"
        />
        <path
          d="M5255 1054 c-276 -46 -587 -227 -935 -541 l-54 -50 74 -23 c41 -13
    ...
    33 56 33 62 0 15 -49 46 -147 95 -207 104 -386 135 -588 100z"
        />
        <path
          d="M7249 1054 c-42 -7 -109 -25 -150 -40 -76 -27 -226 -101 -267 -133
